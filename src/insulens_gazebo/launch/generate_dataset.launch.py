...
def generate_launch_description() -> LaunchDescription:
    ...
    insulens_share = get_package_share_directory("insulens_gazebo")
    world = os.path.join(insulens_share, "worlds", "insulator_dataset.world")
    model_path = os.path.join(insulens_share, "models")
    existing_model_path = os.environ.get("GAZEBO_MODEL_PATH", "")
    generator = Node(
        package="insulens_gazebo",
        ...
        [
            DeclareLaunchArgument(
                ...
                default_value=os.path.join(
                    os.getcwd(), "datasets", "insulator_sim"
                ),
            ),
