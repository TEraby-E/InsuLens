...
class YoloV10Detector(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter(
            "model_path",
            "/root/doggo/models/insulator_defect_yolov10s.pt",
        )
        ...
        self.declare_parameter(
            "evidence_dir", "/root/doggo/inspection_results"
        )
        ...
        if not model_path.is_file():
            raise FileNotFoundError(
                ...
                "ros2 run doggo_perception train_yolov10 first."
            )
        try:
            import torch
        ...
        self.defect_publisher = self.create_publisher(
            String, "/doggo/defect_alerts", 10
        )
        self.latency_publisher = self.create_publisher(
            Float32, "/doggo/inference_ms", 10
        )
